...
function PortfolioMiniChat({ sessionId, onCreateSession }: PortfolioMiniChatProps) {
  ...
  return (
    <section className="relative flex h-[400px] min-h-0 flex-col overflow-hidden rounded-[28px] border border-white/60 bg-white/70 shadow-[0_28px_90px_-36px_rgba(15,23,42,0.5)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/60 dark:shadow-[0_28px_90px_-36px_rgba(2,6,23,0.95)]">
