...
MARKET_NEWS_INDEX_BODY = {
    ...
    "mappings": {
        "properties": {
            ...
            "translation_provider": {"type": "keyword"},
...
INGESTION_RUNS_INDEX_BODY = {
    "mappings": {
        "properties": {
            ...
            "embedding_error": {"type": "keyword"},
            "embedding_primary_provider": {"type": "keyword"},
            ...
            "translation_requested": {"type": "integer"},
            "translation_succeeded": {"type": "integer"},
...
EXPECTED_CHUNK_FIELD_TYPES = {
    ...
    "crawl_error": "keyword",
    "translation_status": "keyword",
    "translation_provider": "keyword",
    "translation_model": "keyword",
    "translation_error": "keyword",
    "translated_at": "date",
    "chunk_index": "integer",
    "chunk_count": "integer",
